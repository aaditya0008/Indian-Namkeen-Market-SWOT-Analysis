    ...
    if os.path.exists(file_path):
        try:
            ...
            if 'Brand' in df.columns:
                ...
                print(f"⚠️ 'Brand' column not found in: {file_path}")
...
# === Step 6: Save chart and data ===
output_csv = r'data\category_breadth.csv'
output_chart = r'data\category_breadth_chart.png'

df_breadth.to_csv(output_csv, index=False)
